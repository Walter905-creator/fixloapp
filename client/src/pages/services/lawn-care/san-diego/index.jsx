...
export default function LawnCareSanDiegoPage() {
  return (
    <>
      <Helmet>
        <title>Lawn Care in San Diego — Fast & Trusted — No Cap | Fixlo</title>
        <meta name="description" content="Find verified lawn care pros in San Diego. Book in 6-7 minutes. The GOAT of home services. No cap! 🏠✨" />
        <meta name="keywords" content="lawn care, lawn care San Diego, lawn care professionals, San Diego contractors, home services San Diego" />
        <link rel="canonical" href="https://fixloapp.com/services/lawn-care/san-diego" />
        <script type="application/ld+json">
          {{"@context":"https://schema.org","@type":"LocalBusiness","name":"Fixlo Lawn Care - San Diego","description":"Professional lawn care services in San Diego","url":"https://fixloapp.com/services/lawn-care/san-diego","telephone":"+1-855-FIXLO-GO","priceRange":"$$","address":{"@type":"PostalAddress","addressLocality":"San Diego","addressCountry":"US"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"2847"},"areaServed":{"@type":"City","name":"San Diego"}}}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
        ...
        <div className="container-xl py-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">
            Lawn Care in San Diego, CA — Fast & Trusted — No Cap
          </h1>
          
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-slate-700 leading-relaxed">
              Looking for lawn care pros in San Diego who bring that <span className="font-semibold">main character</span> energy? 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Trusted Lawn Care Professionals in San Diego
            </h2>
            
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-700 mb-4">
                Our lawn care pros in San Diego? They <span className="font-semibold">ate and left no crumbs</span>. 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Lawn Care Services We Offer in San Diego, CA
            </h2>
        ...
        <div className="bg-slate-900 text-white py-12">
          <div className="container-xl">
            ...
            <p className="text-lg text-slate-200 mb-6">
              ...
              Whether it's your kitchen, bathroom, or entire home, our lawn care pros in San Diego 
        ...
        <div id="request-service" className="bg-white py-12">
          <div className="container-xl">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Request Lawn Care Service in San Diego
              </h2>
              
              <div className="card p-8">
                <p className="text-slate-700 mb-6">
                  Describe your lawn care needs and get matched with verified pros in San Diego, CA.
                </p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12">
          <div className="container-xl text-center">
            ...
            <p className="text-xl mb-6">
              Book the <strong>GOAT</strong> of lawn care in San Diego today — <strong>no cap</strong>.
            </p>
            <a 
              href="#request-service" 
