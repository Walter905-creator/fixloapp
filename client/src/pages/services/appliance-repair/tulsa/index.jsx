...
export default function ApplianceRepairTulsaPage() {
  return (
    <>
      <Helmet>
        <title>Appliance Repair in Tulsa — Fast & Trusted — No Cap | Fixlo</title>
        <meta name="description" content="Find verified appliance repair pros in Tulsa. Book in 6-7 minutes. The GOAT of home services. No cap! 🏠✨" />
        <link rel="canonical" href="https://fixloapp.com/services/appliance-repair/tulsa" />
        <script type="application/ld+json">
          {{"@context":"https://schema.org","@type":"LocalBusiness","name":"Fixlo Appliance Repair - Tulsa","description":"Professional appliance repair services in Tulsa","url":"https://fixloapp.com/services/appliance-repair/tulsa","telephone":"+1-855-FIXLO-GO","priceRange":"$$","address":{"@type":"PostalAddress","addressLocality":"Tulsa","addressCountry":"US"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"2847"},"areaServed":{"@type":"City","name":"Tulsa"}}}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
        ...
        <div className="container-xl py-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">
            Appliance Repair in Tulsa, OK — Fast & Trusted — No Cap
          </h1>
          
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-slate-700 leading-relaxed">
              Looking for appliance repair pros in Tulsa who bring that <span className="font-semibold">main character</span> energy? 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Trusted Appliance Repair Professionals in Tulsa
            </h2>
            
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-700 mb-4">
                Our appliance repair pros in Tulsa? They <span className="font-semibold">ate and left no crumbs</span>. 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Appliance Repair Services We Offer in Tulsa, OK
            </h2>
        ...
        <div className="bg-slate-900 text-white py-12">
          <div className="container-xl">
            ...
            <p className="text-lg text-slate-200 mb-6">
              ...
              Whether it's your kitchen, bathroom, or entire home, our appliance repair pros in Tulsa 
        ...
        <div id="request-service" className="bg-white py-12">
          <div className="container-xl">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Request Appliance Repair Service in Tulsa
              </h2>
              
              <div className="card p-8">
                <p className="text-slate-700 mb-6">
                  Describe your appliance repair needs and get matched with verified pros in Tulsa, OK.
                </p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12">
          <div className="container-xl text-center">
            ...
            <p className="text-xl mb-6">
              Book the <strong>GOAT</strong> of appliance repair in Tulsa today — <strong>no cap</strong>.
            </p>
            <a 
              href="#request-service" 
