...
export default function PlumbingVirginiaBeachPage() {
  return (
    <>
      <Helmet>
        <title>Plumbing in Virginia Beach — Fast & Trusted — No Cap | Fixlo</title>
        <meta name="description" content="Find verified plumbing pros in Virginia Beach. Book in 6-7 minutes. The GOAT of home services. No cap! 🏠✨" />
        <link rel="canonical" href="https://fixloapp.com/services/plumbing/virginia-beach" />
        <script type="application/ld+json">
          {{"@context":"https://schema.org","@type":"LocalBusiness","name":"Fixlo Plumbing - Virginia Beach","description":"Professional plumbing services in Virginia Beach","url":"https://fixloapp.com/services/plumbing/virginia-beach","telephone":"+1-855-FIXLO-GO","priceRange":"$$","address":{"@type":"PostalAddress","addressLocality":"Virginia Beach","addressCountry":"US"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"2847"},"areaServed":{"@type":"City","name":"Virginia Beach"}}}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
        ...
        <div className="container-xl py-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">
            Plumbing in Virginia Beach, VA — Fast & Trusted — No Cap
          </h1>
          
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-slate-700 leading-relaxed">
              Looking for plumbing pros in Virginia Beach who bring that <span className="font-semibold">main character</span> energy? 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Trusted Plumbing Professionals in Virginia Beach
            </h2>
            
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-700 mb-4">
                Our plumbing pros in Virginia Beach? They <span className="font-semibold">ate and left no crumbs</span>. 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Plumbing Services We Offer in Virginia Beach, VA
            </h2>
        ...
        <div className="bg-slate-900 text-white py-12">
          <div className="container-xl">
            ...
            <p className="text-lg text-slate-200 mb-6">
              ...
              Whether it's your kitchen, bathroom, or entire home, our plumbing pros in Virginia Beach 
        ...
        <div id="request-service" className="bg-white py-12">
          <div className="container-xl">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Request Plumbing Service in Virginia Beach
              </h2>
              
              <div className="card p-8">
                <p className="text-slate-700 mb-6">
                  Describe your plumbing needs and get matched with verified pros in Virginia Beach, VA.
                </p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12">
          <div className="container-xl text-center">
            ...
            <p className="text-xl mb-6">
              Book the <strong>GOAT</strong> of plumbing in Virginia Beach today — <strong>no cap</strong>.
            </p>
            <a 
              href="#request-service" 
