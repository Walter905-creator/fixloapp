...
export default function ElectricalSanFranciscoPage() {
  return (
    <>
      <Helmet>
        <title>Electrical in San Francisco — Fast & Trusted — No Cap | Fixlo</title>
        <meta name="description" content="Find verified electrical pros in San Francisco. Book in 6-7 minutes. The GOAT of home services. No cap! 🏠✨" />
        <link rel="canonical" href="https://fixloapp.com/services/electrical/san-francisco" />
        <script type="application/ld+json">
          {{"@context":"https://schema.org","@type":"LocalBusiness","name":"Fixlo Electrical - San Francisco","description":"Professional electrical services in San Francisco","url":"https://fixloapp.com/services/electrical/san-francisco","telephone":"+1-855-FIXLO-GO","priceRange":"$$","address":{"@type":"PostalAddress","addressLocality":"San Francisco","addressCountry":"US"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"2847"},"areaServed":{"@type":"City","name":"San Francisco"}}}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
        ...
        <div className="container-xl py-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">
            Electrical in San Francisco, CA — Fast & Trusted — No Cap
          </h1>
          
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-slate-700 leading-relaxed">
              Looking for electrical pros in San Francisco who bring that <span className="font-semibold">main character</span> energy? 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Trusted Electrical Professionals in San Francisco
            </h2>
            
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-700 mb-4">
                Our electrical pros in San Francisco? They <span className="font-semibold">ate and left no crumbs</span>. 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Electrical Services We Offer in San Francisco, CA
            </h2>
        ...
        <div className="bg-slate-900 text-white py-12">
          <div className="container-xl">
            ...
            <p className="text-lg text-slate-200 mb-6">
              ...
              Whether it's your kitchen, bathroom, or entire home, our electrical pros in San Francisco 
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="card p-8">
                <p className="text-slate-700 mb-6">
                  Describe your electrical needs and get matched with verified pros in San Francisco, CA.
                </p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12">
          <div className="container-xl text-center">
            ...
            <p className="text-xl mb-6">
              Book the <strong>GOAT</strong> of electrical in San Francisco today — <strong>no cap</strong>.
            </p>
            <a 
              href="#request-service" 
