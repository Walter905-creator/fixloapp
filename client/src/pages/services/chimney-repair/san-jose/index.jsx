...
export default function ChimneyRepairSanJosePage() {
  return (
    <>
      <Helmet>
        <title>Chimney Repair in San Jose — Fast & Trusted — No Cap | Fixlo</title>
        <meta name="description" content="Find verified chimney repair pros in San Jose. Book in 6-7 minutes. The GOAT of home services. No cap! 🏠✨" />
        <meta name="keywords" content="chimney repair, chimney repair San Jose, chimney repair professionals, San Jose contractors, home services San Jose" />
        <link rel="canonical" href="https://fixloapp.com/services/chimney-repair/san-jose" />
        <script type="application/ld+json">
          {{"@context":"https://schema.org","@type":"LocalBusiness","name":"Fixlo Chimney Repair - San Jose","description":"Professional chimney repair services in San Jose","url":"https://fixloapp.com/services/chimney-repair/san-jose","telephone":"+1-855-FIXLO-GO","priceRange":"$$","address":{"@type":"PostalAddress","addressLocality":"San Jose","addressCountry":"US"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","reviewCount":"2847"},"areaServed":{"@type":"City","name":"San Jose"}}}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
        ...
        <div className="container-xl py-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">
            Chimney Repair in San Jose, CA — Fast & Trusted — No Cap
          </h1>
          
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-xl text-slate-700 leading-relaxed">
              Looking for chimney repair pros in San Jose who bring that <span className="font-semibold">main character</span> energy? 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Trusted Chimney Repair Professionals in San Jose
            </h2>
            
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-700 mb-4">
                Our chimney repair pros in San Jose? They <span className="font-semibold">ate and left no crumbs</span>. 
        ...
        <div className="bg-white py-12">
          <div className="container-xl">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Chimney Repair Services We Offer in San Jose, CA
            </h2>
        ...
        <div className="bg-slate-900 text-white py-12">
          <div className="container-xl">
            ...
            <p className="text-lg text-slate-200 mb-6">
              ...
              Whether it's your kitchen, bathroom, or entire home, our chimney repair pros in San Jose 
        ...
        <div id="request-service" className="bg-white py-12">
          <div className="container-xl">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">
                Request Chimney Repair Service in San Jose
              </h2>
              
              <div className="card p-8">
                <p className="text-slate-700 mb-6">
                  Describe your chimney repair needs and get matched with verified pros in San Jose, CA.
                </p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12">
          <div className="container-xl text-center">
            ...
            <p className="text-xl mb-6">
              Book the <strong>GOAT</strong> of chimney repair in San Jose today — <strong>no cap</strong>.
            </p>
            <a 
              href="#request-service" 
