  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10 prose prose-invert">
      <Helmet>
        ...
        <meta
          name="description"
          content="Terms & Conditions for using Fixlo's website, marketplace, subscriptions, and services."
        />
      ...
      <p>
        ...
        (e.g., Stripe). Pricing and plan details are shown at checkout and/or on our Pricing page. Taxes may apply.
      </p>
      <ul>
        <li>
