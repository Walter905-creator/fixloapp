      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid gap-4 md:grid-cols-3 text-left">
          <div className="rounded-2xl border-2 border-emerald-400 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-extrabold text-slate-900">Request<span className="text-base font-medium"> a quote</span></p>
            <p className="mt-3 text-slate-700">Get matched with verified local professionals and receive a detailed quote before any work begins. Nationwide — all cities, all services.</p>
            <button
