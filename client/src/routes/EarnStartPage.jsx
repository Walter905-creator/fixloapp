 ...
 * - Redirects to /earn/dashboard after verification
 */
  ...
  const handleVerificationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.ok && data.referrer) {
        // Store referrer session in localStorage
        localStorage.setItem('fixlo_referrer', JSON.stringify({
