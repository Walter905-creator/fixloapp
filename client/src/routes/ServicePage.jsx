...
function ServiceLeadForm({service, city}){
  ...
  return (<form onSubmit={submit} className="mt-4 space-y-3">
    ...
    <div className="flex items-center gap-2"><input id="svc-city-sms" type="checkbox" className="h-4 w-4" required/><label htmlFor="svc-city-sms" className="text-xs text-slate-400">I agree to receive SMS related to quotes, scheduling, and service updates. Reply STOP to unsubscribe.</label></div>
