  ...
  const handleClockOut = async (jobId) => {
    ...
    try {
      ...
      alert(
        ...
        'Labor: $' + Number(data.laborCost || 0).toFixed(2) + '\n' +
        'Materials: $' + Number(data.materialCost || data.materialsCost || 0).toFixed(2) + '\n' +
        'Total charged: $' + Number(data.amountChargedAtCompletion || data.totalCharged || 0).toFixed(2) +
