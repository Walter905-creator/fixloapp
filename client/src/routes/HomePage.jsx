...
const U4x3 = (q) =>
  `https://source.unsplash.com/1200x900/?${encodeURIComponent(q)}`;
const U16x9 = (q) =>
  `https://source.unsplash.com/1200x675/?${encodeURIComponent(q)}`;

// Hero + How it Works
const HERO_IMG = U16x9(
  "handyman, residential, inside home, friendly, bright, smiling, no hardhat"
);
const HOW_IMG = U16x9(
  "homeowner couple with contractor, living room, tablet, bright, residential"
);
...
const SERVICES = [
  {
    ...
    img: U4x3(
      "plumber fixing sink, kitchen, residential, bright, no hardhat"
    ),
  },
  {
    ...
    img: U4x3(
      "electrician at breaker panel, residential home, bright, no hardhat"
    ),
  },
  {
    ...
    img: U4x3(
      "house cleaner vacuum living room, residential, bright, tidy"
    ),
  },
  {
    to: "/services/roofing",
    ...
    img: U4x3(
      "roofer installing shingles, small house, residential, daylight, no hardhat"
    ),
  },
  {
    to: "/services/hvac",
    ...
    img: U4x3(
      "hvac technician checking outdoor ac unit, home exterior, residential"
    ),
  },
  {
    ...
    img: U4x3(
      "carpenter measuring wood, home garage workshop, residential"
    ),
  },
  {
    ...
    img: U4x3(
      "painter rolling paint on wall, interior, residential, bright"
    ),
  },
  {
    ...
    img: U4x3(
      "landscaper mowing front yard, trimming hedges, residential, sunny"
    ),
  },
  {
    ...
    img: U4x3(
      "junk removal loading furniture into small truck, driveway, residential"
    ),
  },
  {
    to: "/services/decks",
    ...
    img: U4x3(
      "contractor building backyard deck, residential house, sunny"
    ),
  },
  {
            ...
            <div>
              ...
              <div className="mt-6">
                <div className="flex items-center gap-3 bg-white rounded-2xl p-2 shadow-md border border-slate-200">
                  ...
                  <Link
                    to="/services"
                    className="btn-accent px-5 py-3 rounded-xl"
                  >
                    Search
                  </Link>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center text-slate-900">
            <div>
              ...
              <p className="mt-3 text-slate-600">
                Tell us what you need, get matched to vetted pros, and compare
                quotes. Book the one that fits your project and budget.
              </p>
