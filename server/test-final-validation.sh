...
echo "TEST 1: Server should exit when MONGODB_URI is missing"
echo "================================================================"
node index.js > /tmp/test1.log 2>&1
EXIT_CODE=$?
echo "Exit code: $EXIT_CODE"
grep -E "MONGODB_URI is missing|FATAL ERROR" /tmp/test1.log | head -3
...
echo "TEST 2: Server should exit when MONGODB_URI is malformed"
echo "================================================================"
MONGODB_URI="invalid-uri" node index.js > /tmp/test2.log 2>&1
EXIT_CODE=$?
echo "Exit code: $EXIT_CODE"
...
echo "================================================================"
MONGODB_URI="mongodb://192.0.2.1:27017/test" node index.js > /tmp/test3.log 2>&1
EXIT_CODE=$?
echo "Exit code: $EXIT_CODE"
...
echo "  - Server fails to start without valid MONGODB_URI"
echo "  - Server fails to start with invalid MONGODB_URI"
