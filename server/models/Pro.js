...
const proSchema = new mongoose.Schema({
  ...
  // 'invite_redeemed' is set when an invitation code is redeemed (free access for the code's duration)
  subscriptionStatus: {
    type: String,
    enum: ['active', 'inactive', 'cancelled', 'past_due', 'paused', 'pending', 'invite_redeemed'],
    default: 'pending'
  },
